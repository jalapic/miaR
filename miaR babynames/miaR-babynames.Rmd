...
First, I narrowed down the criteria that I wanted to work with by using filter(). I chose to work with babynames from the year 2002 — my birth year. 
...
ggplot(b, aes(x=name, y=n, by=sex)) +
  geom_col()
```
